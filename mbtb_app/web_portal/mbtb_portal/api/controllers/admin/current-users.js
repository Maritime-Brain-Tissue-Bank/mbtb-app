...
module.exports = {
  ...
  friendlyName: 'Current Users',


  description: 'Retrieve current users from API',
  ...
  exits: {
    success: {
      viewTemplatePath: 'pages/admin_view_current_users',
  ...
  fn: async function (inputs, exits) {
    let url = sails.config.custom.user_api_url + 'current_users/';
